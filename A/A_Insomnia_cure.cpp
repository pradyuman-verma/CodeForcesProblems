...
void solve(){
    int k, l, m, n, d;
    cin >> k >> l >> m >> n >> d;
    int a = LCM(k, l), b = LCM(k, m), c = LCM(k, n), e = LCM(l, m), f = LCM(l, n), i = LCM(m, n);
    int n1 = (d / k) + (d / l) + (d / m) + (d / n);
    int n2 = (d / a) + (d / b) + (d / c) + (d / e) + (d / f) + (d / i);
    int n3 = (d / LCM(k, l, m)) + (d / LCM(k, m, n)) + (d / LCM(l, m, n)) + (d / LCM(k, l, n));
    int n4 = (d / LCM(k, l, m, n));
    cout << n1 - n2 + n3 - n4 ;
}
