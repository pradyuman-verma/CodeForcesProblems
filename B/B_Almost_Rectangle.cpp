...
void solve(){
    ...
    if(arr[0].first == arr[1].first || arr[0].second == arr[1].second){
        if(arr[0].first == arr[1].first){
            if(arr[0].first == 0){
                temp[arr[0].first + 1][arr[0].second] = '*'; 
                temp[arr[0].first + 1][arr[1].second] = '*'; 
            }else{
                temp[arr[0].first - 1][arr[0].second] = '*'; 
                temp[arr[0].first - 1][arr[1].second] = '*';
            }
        ...
        if(arr[0].second == arr[1].second){
            if(arr[0].second == 0){
                temp[arr[0].first][arr[0].second + 1] = '*'; 
                temp[arr[0].first][arr[1].second + 1] = '*'; 
            }else{
                temp[arr[0].first][arr[0].second - 1] = '*'; 
                temp[arr[0].first][arr[1].second - 1] = '*'; 
            }
        ...
        temp[arr[0].first][arr[1].second] = '*';
        temp[arr[0].second][arr[1].first] = '*';
    }
    for(auto x : temp){
        cout << x << endl;
    }
